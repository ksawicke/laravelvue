<header class="app-header navbar">
    ...
    <ul class="nav navbar-nav d-md-down-none">
        ...
        --}}
        <li class="nav-item px-3">
            <a class="nav-link" href="/sample/dashboard"><strong>Example Laravel 5.7 and Vue.js 2.5.17 App</strong></a>
        </li>
    </ul>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button"
               aria-haspopup="true" aria-expanded="false">
                ...
                @if (Auth::check())
                    <img
                        src="https://www.gravatar.com/avatar/{{md5(strtolower(trim(Auth::user()->email)))}}?s=160&d=retro"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-header text-center">
                    <strong><?php /***{{ auth()->user()->name }}***/ ?>Kevin's Account</strong>
                </div>
